# Otoware-V2
「**音割れマイスター V2**（旧名：音割戦隊ウルセンジャー - ピークレッドV2）」とは、入力した音源のラウドネスを最大化するよう音割れさせるプログラムおよびアプリケーションです  
...
あるときはCubaseを使ってクリッパーを最大出力で連結させたり、  
またある時はReaperを使って+20dBしてあるEQを何千個もインサートしたり、  
気づけばPythonでコードを書いて、改良に改良を重ね、  
ついにはデスクトップアプリにまで漕ぎ着けました  
そんないっぺーによる音割れ研究の進捗をまとめてみました  
　  
**音割れマイスター_V2.exe**  
...
　  
### おわりに
冒頭でもある通り、元々このアプリは **「とにかくクソうるさい音源を作りたいっ！！！」** っていう好奇心をバネに作り続けていたんですが、その終着点が無限大という、全く持って当たり前な結論に落ち着いているのにも関わらず、音源は再生できないというパラドックスにぶち当たり、何とも不思議な感覚です  
　  
