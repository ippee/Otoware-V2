...
![コメント 2020-02-09 153017](https://user-images.githubusercontent.com/29997720/74097635-cc492000-4b51-11ea-8eac-f3aa5f74fb29.jpg)
　  
　  
## アプリの使い方
...
この変換時にbit floatの崩れる瞬間を狙うことが、bit float音源の出力に対応させている理由です
　  
### 補足：メディアプレイヤーによるbit float音源の扱いの違い
例えばWindows Media PlayerやVLCメディアプレイヤーでは、0dBFSを越えた分はノーマライズされて再生されます  
...
　  
ということはですよ。  
**とりあえずボリュームを+10,000dBとかデカい数字を入れておけば、32bit float音源と言えども音割れすんじゃね？！？！？！　フォオオオ～ッ♪**  
　  
と、思ってやってみたんですが……  
　  
いくらゲインを高くしても、このアプリの示すラウドネスが最大となるポイントは+770dBが限界で、この数値以降のラウドネスの推移もカットされ表示されませんでした  
　  
+770dBで止まるなら、+771dBで書き出したらどうなるんだろうと思い、出力して再生してみたところ、**ま　さ　か　の　無　音**  
Audacityで波形を見たら変に表示されてるし   

![波形](https://user-images.githubusercontent.com/29997720/74097557-8e97c780-4b50-11ea-969b-c036e7101eb2.jpg)
...
　  
### おわりに
元々このアプリは、**「とにかくクソうるさい音源を作りたいっ！」** っていう好奇心をバネに作り続けていたんですが、その終着点が無限大という、全く持って当たり前な結論に落ち着いているのにも関わらず、音源は再生できないというパラドックスにぶち当たり、何とも不思議な感覚です  
　  
だって無限大の音とか気になりません？　台風以上の圧力ですよ？  
え？　それもう音じゃない？  
　  
次に音割れを追求する機会があるなら、音響工学の方向に突っ走るんですかね  
気が向いたらまた実験してみようと思います  
　  
### 参考
- 実数の表現 | 情報の表現
